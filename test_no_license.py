...
# database. Repeats the test and checks that five managers can log in but no editors should   #
# be able to.                                                                                 #
#                                                                                             #
###############################################################################################
import unittest
...
class NoLicenseTest(unittest.TestCase):
    @classmethod
    def setUpClass(inst):
        print 'Start of test: test_no_license'
