...
from test_emergency_login import EmergencyLoginTest
...
emergency_login_tests = unittest.TestLoader().loadTestsFromTestCase(EmergencyLoginTest)

# create a test suite
test_suite = unittest.TestSuite([login_tests, valid_license_tests, license_expired_tests, license_not_yet_valid_tests, incorrect_ip_address_tests, license_invalid_version_tests, corrupted_license_tests, remove_license_table_tests, remove_license_tests, no_license_tests, emergency_login_tests])
...
runner = HTMLTestRunner.HTMLTestRunner(stream=outfile,title='Go! User Management Test Report', version='T 7.0.0.21')
