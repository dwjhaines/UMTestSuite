###############################################################################################
#                                                                                             # 
# test_license_invalid_version.py                                                             #
#                                                                                             # 
# Tests that up to five administrators can log in when the license has an invalid version     #
# number. Repeats the test and checks that five managers can log in but no editors should be  #
# able to.                                                                                    # 
#                                                                                             #
###############################################################################################
import unittest
...
class InvalidVersionTest(unittest.TestCase):
    @classmethod
    def setUpClass(inst):
        ...
        inst.maxUsers = db_utils.addUserLicenseInvalidVersion (inst.connection, inst.cur)
