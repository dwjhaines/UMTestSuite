###############################################################################################
#                                                                                             # 
# test_incorrect_ip_address.py                                                                #
#                                                                                             # 
# Tests that up to five administrators can log in when the ip address in the license is not   #
# correct. Repeats the test and checks that five managers can log in but no editors should be #
# able to                                                                                     # 
#                                                                                             #
###############################################################################################
import unittest
...
class IncorrectIPAddressTest(unittest.TestCase):
    ...
    def setUpClass(inst):
        ...
        inst.maxUsers = db_utils.addUserLicenseIncorrectIPAddress (inst.connection, inst.cur)
